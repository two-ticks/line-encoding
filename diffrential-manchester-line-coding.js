...
text("Differential Manchester ", width/2+300+10,0.2*height+30);
text("Encoding", width/2+370+10,0.2*height+60);    
...
function manchester(x){
    ...
    stroke(230,50,20);
    strokeWeight(3);
    if(x%10==0){ line(0.1*width-80,height/2+100,0.1*width-80,height/2-100); }
    pop();
